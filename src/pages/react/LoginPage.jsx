...
<div className="container-flex text-center" style={{ height: '100vh' }}>
  ...
  <div className="row" style={{ height: '100%' }}>
    ...
    <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6 left d-flex flex-column align-items-center justify-content-center">
      ...
      <div>
        <p className="description">
          ...
          and safety across Sri Lanka.<hr className="line" />
    ...
    <div className="right col-sm-12 col-md-6 col-lg-6 col-xl-6  d-flex flex-column align-items-center justify-content-center">
      <h1 className='righttitle'>Login</h1><hr className='rightline'/>
      <div>
     ...
     <Form >
      {['radio'].map((type) => (
        <div key={`inline-${type}`} className="mb-3">
          ...
          <Form.Check
            inline
            label={<span className="custom-label">Locomotive pilot</span>}
            name="group1"
            type={type}
            id={`inline-${type}-2`}
            className="custom-radio"
      ...
      <Form.Group controlId="formUsername" className="mb-3">
        <Form.Control type="text" placeholder="Enter username" className="custom-textbox" />
      </Form.Group>

      <Form.Group controlId="formPassword" className="mb-3">
        <Form.Control type="password" placeholder="Enter password" className="custom-textbox" />
      </Form.Group>
